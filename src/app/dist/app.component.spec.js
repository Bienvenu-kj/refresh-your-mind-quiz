...
describe('AppComponent', function () {
    ...
    it("should have the 'Refresh Your Mind - Quiz Informatique' title", function () {
        var fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        var app = fixture.componentInstance;
    ...
    it('should render title', function () {
        ...
        expect((_a = compiled.querySelector('h1')) === null || _a === void 0 ? void 0 : _a.textContent).toContain('REfresh your mind');
    });
});
